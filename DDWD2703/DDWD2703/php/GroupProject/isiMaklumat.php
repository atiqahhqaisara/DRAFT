...
<input type ="submit" value="Submit" onclick="branch()">
<p id="result"></p>
	</div>

<h3>Request for an appoinment </h3>

	<form action="processMaklumat.php" method = "POST" >
	<div>
	Branch ID: <br><input type="text" class="w3-input w3-border w3-round-large" name="branchId">
	<br>Branch Name: <br><input type="text"class="w3-input w3-border w3-round-large" name="branchName">
	<br>Address 1: <br><input type="text" class="w3-input w3-border w3-round-large"name="address1">
	<br>Address 2: <br><input type="text" class="w3-input w3-border w3-round-large"name="address2">
	<br>Postcode:  <br><input type="text" class="w3-input w3-border w3-round-large"name="postcode">
	<br>District: <br><input type="text" class="w3-input w3-border w3-round-large"name="district">
	<br>State:  <br><input type="text" class="w3-input w3-border w3-round-large"name="state">
	<br>Email:  <br><input type="text" class="w3-input w3-border w3-round-large"name="email">
	<br>Phone Number:  <br><input type="text" class="w3-input w3-border w3-round-large"name="phoneNumber">
	<br> <input type = "submit" value="Save" name="addAppoinmentButton">
	</div>
